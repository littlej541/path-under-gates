...
public class ModItems {
    private static final DeferredRegister<Item> ITEMBLOCKS_OVERRIDE = DeferredRegister.create(ForgeRegistries.ITEMS, Blocks.GRASS_PATH.getRegistryName().getNamespace());
